...
use App\Models\{Upps, Periode, PeningkatanUpps};
...
class Status extends Component
{
    ...
    public function mount()
    {
        ...
        $this->penetapan_date = $this->peningkatanUpps->penetapan_date;
    ...
    {   
        ...
        return redirect()->route('dashboard.spmi.peningkatan', [
            'upps' => $this->upps,
            'periode' => $this->periode
        ])->with('success', 'Successfully update peningkatan');
    }
    ...
    {
        return view('livewire.dashboard.spmi.peningkatan.status', [
            'upps' => $this->upps,
            'periode' => $this->periode,
