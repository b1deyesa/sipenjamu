<nav class="admin__sidebar" x-data="{ showLabels: localStorage.getItem('adminSidebar') === 'true' }" x-init="$watch('showLabels', val => localStorage.setItem('adminSidebar', val))">
    ...
    {{-- Sidebar Menu --}}
    <div class="sidebar__menu" :class="{ 'open': showLabels }" style="align-items: flex-start">
        <div class="menu__dropdown" x-data="{ open: {{ request()->routeIs('dashboard.admin.register.*') ? 'true' : 'false' }} }">
            ...
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.register.periode') ? 'active' : '' }}" href="{{ route('dashboard.admin.register.periode') }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Periode</span></a>
        </div>
        ...
        <div class="menu__dropdown" x-data="{ open: {{ request()->routeIs('dashboard.admin.spmi.*') ? 'true' : 'false' }} }">
            ...
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.profil') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.profil', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Profil</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.standar-yang-ditetapkan-institusi') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.standar-yang-ditetapkan-institusi', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Standar Yang Ditetapkan Institusi</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.standar-lain') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.standar-lain', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Standar Lain</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.pelaksanaan') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.pelaksanaan', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Pelaksanaan</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.evaluasi-lain') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.evaluasi-lain', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Evaluasi Lain</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.pengendalian') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.pengendalian', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Pengendalian</span></a>
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.spmi.peningkatan') ? 'active' : '' }}" href="{{ route('dashboard.admin.spmi.peningkatan', ['periode' => $periode]) }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Peningkatan</span></a>
        </div>
        <hr class="menu__separator">
        <div class="menu__dropdown" x-data="{ open: {{ request()->routeIs('dashboard.admin.monev.*') ? 'true' : 'false' }} }">
            ...
            <a x-show="open" class="menu__item {{ request()->routeIs('dashboard.admin.monev.tks') ? 'active' : '' }}" href="{{ route('dashboard.admin.monev.tks') }}"><i class="fa-solid fa-circle-notch"></i><span x-show="showLabels" x-transition>Instrumen TKS</span></a>
        </div>
    </div>
