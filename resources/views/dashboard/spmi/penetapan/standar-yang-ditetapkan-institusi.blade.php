        ...
        <x-slot:body>
            @forelse ($standarYangDitetapkanInstitusiUppses as $standarYangDitetapkanInstitusiUpps)
                <tr>
                    ...
                    <td>@livewire('dashboard.spmi.standar-yang-ditetapkan-institusi.status', compact('upps', 'periode', 'standarYangDitetapkanInstitusiUpps'), key($standarYangDitetapkanInstitusiUpps->id))</td>
                    @if ($standarYangDitetapkanInstitusiUpps->setting_status == 'Ada')
                        ...
                        <td>
                            <div class="table__action">
                                @livewire('dashboard.spmi.standar-yang-ditetapkan-institusi.update', compact('upps', 'periode', 'standarYangDitetapkanInstitusiUpps'), key($standarYangDitetapkanInstitusiUpps->id))
                            </div>
                        </td>
                    @else
                        ...
                        @else
                            <td colspan="3" align="center"><small style="font-size: .9em; opacity: 50%">Belum Disi</small></td>
                            <td></td>
                        @endif
                    @endif
                </tr>
